...
export default function BrandClientPage({ params }: BrandPageProps) {
    ...
    <div className="relative min-h-screen">
      ...
      <section className="py-16 md:py-20 bg-emerald-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-emerald-900 mb-6">À propos de {brand.name}</h2>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-emerald-900 mb-4">
              Découvrez nos produits {brand.name}
            </h2>
            <p className="text-lg text-emerald-800 max-w-2xl mx-auto">
              Une sélection de produits innovants pour répondre à tous vos besoins.
            </p>
          </motion.div>
